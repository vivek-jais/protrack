...
export default function ManageProjectsPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50 text-gray-900 dark:bg-[#09090b] dark:text-white">
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 p-6 md:p-12 font-sans dark:bg-[#09090b] dark:text-white">
      <ToastContainer theme="dark" />
      
      <div className="mx-auto max-w-7xl space-y-8">

        {/* HEADER */}
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-gray-200 pb-6 dark:border-zinc-800">
          <div>
        ...
        {/* PROJECTS GRID */}
        {projects.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-3xl border-2 border-gray-200 bg-white/80 py-24 text-center dark:border-zinc-800 dark:bg-[#18181b]/50">
            <div className="h-16 w-16 bg-gray-100 rounded-2xl flex items-center justify-center mb-4 border border-gray-200 dark:bg-zinc-900 dark:border-zinc-800">
              <FileText className="h-8 w-8 text-gray-500 dark:text-zinc-600" />
            </div>
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">No projects found</h3>
            <p className="mt-2 text-sm text-gray-500 dark:text-zinc-400 max-w-sm">You haven't created any assignments yet. Click the button above to get started with the AI Architect.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
            {projects.map((project) => (
              <div 
                key={project._id} 
                className="group flex flex-col overflow-hidden rounded-3xl border border-gray-200 bg-white transition-all duration-300 hover:-translate-y-1 hover:border-emerald-500/50 hover:shadow-[0_8px_30px_rgb(16,185,129,0.1)] dark:border-zinc-800 dark:bg-[#18181b]"
              >
                <div className="flex flex-1 flex-col p-6">
                  
                  {/* Title & Icons */}
                  <div className="mb-4 flex items-start justify-between gap-4">
                    <h3 className="text-xl font-bold text-gray-900 line-clamp-2 leading-tight dark:text-white">
                      {project.title}
                    </h3>
                  ...
                  {/* Description */}
                  <p className="mb-6 text-sm text-gray-500 line-clamp-3 leading-relaxed dark:text-zinc-400">
                    {project.description}
                  </p>
      ...
      {editingProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
          <div className="w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden rounded-3xl bg-white border border-gray-200 shadow-2xl dark:bg-[#18181b] dark:border-zinc-800">

            <div className="flex items-center justify-between border-b border-gray-200 px-8 py-5 shrink-0 dark:border-zinc-800">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Edit Project Specification</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-100 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:border-emerald-500 transition-colors dark:bg-[#09090b] dark:border-zinc-800 dark:text-zinc-300"
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-gray-100 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:border-emerald-500 transition-colors resize-none leading-relaxed dark:bg-[#09090b] dark:border-zinc-800 dark:text-zinc-300"
                    />
                  </div>
                </div>
                ...
                <div className="pt-6 border-t border-zinc-800">
                  ...
                  <div className="space-y-4">
                    {editingProject.stages?.map((stage: any, index: number) => (
                      <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-gray-100 p-5 rounded-xl border border-gray-200 dark:bg-[#09090b] dark:border-zinc-800">
            ...
            <div className="flex gap-4 px-8 py-5 border-t border-gray-200 bg-white shrink-0 dark:border-zinc-800 dark:bg-[#18181b]">
              <button type="button" onClick={() => setEditingProject(null)} className="flex-1 rounded-xl border border-gray-200 py-3 text-sm font-bold text-gray-900 hover:bg-gray-100 transition-colors dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-800">
                Cancel
              </button>
      ...
      {deletingProjectId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
          <div className="w-full max-w-sm overflow-hidden rounded-3xl bg-white border border-gray-200 shadow-2xl p-8 text-center dark:bg-[#18181b] dark:border-zinc-800">
