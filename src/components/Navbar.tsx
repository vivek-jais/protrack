  ...
  return (
    <nav className="sticky top-0 z-50 flex h-16 w-full items-center justify-between border-b border-zinc-200 bg-white/80 px-4 backdrop-blur-xl transition-all dark:border-zinc-800 dark:bg-zinc-950/80">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        {role==='student'&&(<button onClick={onClick} className="cursor-pointer flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-3 py-1.5 text-sm font-medium text-zinc-700 shadow-sm transition-all hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-800">
          <Plus className="h-4 w-4" />
          <span className="hidden sm:inline">Create Group</span>
        </button>)}
        {role==='teacher'&&(<button onClick={onClick} className="cursor-pointer flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-3 py-1.5 text-sm font-medium text-zinc-700 shadow-sm transition-all hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-800">
          <Plus className="h-4 w-4" />
